...
public:	
	...
	TcpConnectionPtr get_conn() { return m_conn; }
...
private:
	...
	std::function<int(SSLConnection*, unsigned char*, size_t)> m_SSL_receive_callback;
...
public:
	...
	void SetSSLCertificate()
	{
		...
		const char* cert_path = "../ca/certificate.pem";
		const char* key_path = "../ca/private_key.pem";
